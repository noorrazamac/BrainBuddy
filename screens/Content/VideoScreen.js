...
// Later on in your styles..
  ...
  if(isDataLoaded == false){
    Storage.get(content.source_path,  {
        level: 'public', // defaults to `public`
        
        expires: 3700, // validity of the URL, in seconds. defaults to 900 (15 minutes) and maxes at 3600 (1 hour)
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>BrainBuddy Video</Text>
